...
HRESULT GraphicsDevice_DX::InitilizeDrivers()
{
	HRESULT hr = NULL;
...
HRESULT GraphicsDevice_DX::InitilizeFactory(const HWND g_hWnd)
{
	RECT rc;
...
HRESULT GraphicsDevice_DX::InitilizeTargetView(const HWND g_hWnd)
{
	RECT rc;
	GetClientRect(g_hWnd, &rc);
	const UINT width = rc.right - rc.left;
...
HRESULT GraphicsDevice_DX::CreateDepthStencil(const HWND g_hWnd)
{
	RECT rc;
	GetClientRect(g_hWnd, &rc);
	const UINT width = rc.right - rc.left;
...
ID3D11DeviceContext* GraphicsDevice_DX::getContext() const
{
	return g_pImmediateContext;
}

ID3D11Device* GraphicsDevice_DX::getDevice() const
{
	return g_pd3dDevice;
}

IDXGISwapChain* GraphicsDevice_DX::getSwapChain() const
{
	return g_pSwapChain;
}

ID3D11DepthStencilView* GraphicsDevice_DX::getDepthStencilView() const
{
	return g_pDepthStencilView;
}

ID3D11RenderTargetView* GraphicsDevice_DX::getRenderTargetView() const
{
	return g_pRenderTargetView;
}

D3D_DRIVER_TYPE GraphicsDevice_DX::getDriverType() const
{
	return g_driverType;
}
